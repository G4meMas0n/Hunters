package de.g4memas0n.hunters.command;
...
import static de.g4memas0n.hunters.util.messaging.Messages.tl;
...
public abstract class BasicCommand {
    ...
    public boolean register(@NotNull final Hunters instance) {
    ...
    public final @NotNull Hunters getInstance() {
        if (this.instance == null) {
